...
function dhtmlXAccordion(baseId, skin) {
    ...
    this.isActive = function (itemId) {
        if (String(dhxAccord.idPull[itemId]._content.className).search("dhx_acc_item_content_opened") != -1) return true;
        return false
    };
...
;
(function () {
    dhtmlx.extend_api("dhtmlXAccordion", {_init:function (obj) {
