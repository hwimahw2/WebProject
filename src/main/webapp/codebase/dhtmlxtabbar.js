...
//patch
//ширина и высота таббара
dhtmlXTabBar.prototype.getTabWidth=function(){
    var h=this.entBox.style.width;
    if (h.indexOf('px')==-1)
        return parseInt(h);
    else {
...
dhtmlXTabBar.prototype.getTabHeight=function(){
    var h=this.entBox.style.height;
    if (h.indexOf('px')==-1)
        return parseInt(h);
    else {
        h = h.substr(0, h.indexOf('px'));
