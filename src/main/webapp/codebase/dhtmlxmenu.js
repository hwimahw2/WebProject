...
function dhtmlXMenuObject(baseId, skin) {
    ...
    this.setSkin = function(skin) {
        ...
        this.skin = skin;
        switch (this.skin) {case "standard":
            ...
            case "dhx_blue":
            case "dhx_skyblue":
                this._topLevelBottomMargin = 2;this._topLevelRightMargin = 1;this._topLevelOffsetLeft = 1;this._arrowFFFix = (_isIE ? (document.compatMode == "BackCompat" ? 0 : -4) : -4);break}
        ;
    ...
    this._showPolygon = function(id, openType) {        
        ...
        if ((this.idPull[pId] != null) && (this.idPull[id] != null)) {
            ...
            if (y + h > my && this.menuY2 != null) {
                if(srcH - h + 2 > 0){ // проверка, что менюшка поместится в верхней части : path
                    y = srcY + srcH - h + 2;
    ...
    dhtmlxEvent(document.body, "contextmenu", function(e) {
        ...
        //patch добавлена следующая строка
        if (Object.isUndefined(t)) return;
...
dhtmlXMenuObject.prototype._renderSublevelItem = function(id, pos) {
    ...
    k.onclick = function(e) {
        ...
        var cas = {"ctrl": e.ctrlKey, "alt": e.altKey, "shift": e.shiftKey};
        switch (main_self.itemPull[this.id]["type"]) {case "checkbox":
...
(function() {
    dhtmlx.extend_api("dhtmlXMenuObject", {_init:function(obj) {
