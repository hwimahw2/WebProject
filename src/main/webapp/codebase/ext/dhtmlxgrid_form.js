...
{this.FormSubmitOnlyRowID = convertStringToBoolean(mode)};dhtmlXGridObject.prototype.createFormInput = function(name,value){var input = document.createElement('ru.ncd.input');input.type = 'hidden';if (this._input_mask)input.name=this._input_mask.apply(this,name);else
