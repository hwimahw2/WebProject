...
(function (factory, root) {
    ...
    AjaxAppender.prototype.defaults = {waitForResponse: false, timed: false, timerInterval: 1000, batchSize: 1, sendAllOnUnload: false, requestSuccessCallback: null, failCallback: null, postVarName: "data", contentType: "application/x-www-form-urlencoded"};
    ...
    (function () {
        ...
        var emptyElements = ["br", "img", "hr", "param", "link", "area", "ru.ncd.input", "col", "base", "meta"];
        var indentationUnit = "  ";
